...
# Musica
musica_inicio = os.path.join(BASE_DIR,"assets\\sounds\\A_Binary_Collision.mp3") # sonido menú de inicio de juego
musica_juego = os.path.join(BASE_DIR,"assets\\sounds\\pantera_rosa.mp3") # sonido en estado playing
...
musica_gameover = os.path.join(BASE_DIR,"assets\\sounds\\Game_Over_Sound_Effect.mp3") # sonido game over
